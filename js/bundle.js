...
class Level {
  constructor(level){
    this.level = level
    var view = new __WEBPACK_IMPORTED_MODULE_0__view__["a" /* default */](level)
    var game = new __WEBPACK_IMPORTED_MODULE_1__game__["a" /* default */](this, view);
    this.game = game;
    // this.checkForWin();
  }
  ...
  checkForWin(){
   if (this.game.isWon()) {
     ...
     delete this.view;
     this.level += 1
     let view = new __WEBPACK_IMPORTED_MODULE_0__view__["a" /* default */](this.level)
     this.game = new __WEBPACK_IMPORTED_MODULE_1__game__["a" /* default */](this, view);
   }
  }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__fastclick__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__fastclick___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__fastclick__);
...
$( () => {
    __WEBPACK_IMPORTED_MODULE_4__fastclick___default.a.attach(document.body);
});
